class ResourcesController < ApplicationController
  ...
  def index
    ...
    @number_strings = calculate_sum(Resource.pluck(:quantity))
  end
  ...
  private
    ...
    def calculate_sum(number_strings)
      number_strings.map(&:to_f).sum
    end

    # Only allow a list of trusted parameters through.
    def resource_params
      params.require(:resource).permit(:name, :price, :quantity, :occurrence_id)
    end
end
