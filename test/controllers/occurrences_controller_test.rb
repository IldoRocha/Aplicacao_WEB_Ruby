...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post occurrences_url, params: { occurrence: { cobradeCode: @occurrence.cobradeCode, description: @occurrence.description, name: @occurrence.name } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { cobradeCode: @occurrence.cobradeCode, description: @occurrence.description, name: @occurrence.name } }
